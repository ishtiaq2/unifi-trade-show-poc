...
#
#   ./verify-clean-slate-e2e-integration-ci-cd-ready.sh          interactive (pauses after teardown)
#   ./verify-clean-slate-e2e-integration-ci-cd-ready.sh --yes    non-interactive, for CI/scripting
